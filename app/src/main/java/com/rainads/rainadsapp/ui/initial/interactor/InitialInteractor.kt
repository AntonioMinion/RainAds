...
import com.rainads.rainadsapp.data.network.models.LoginRequest
import com.rainads.rainadsapp.data.network.models.RegisterRequest
...
class InitialInteractor @Inject internal constructor(
    ...
    override fun registerApiCall(email: String, password: String, country: String, referral: String): Observable<User> =
